  ...
  return (
    ...
    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-12 flex-1">
      ...
      <CustomFormField
        ...
        name="email"
        label="Email"
        placeholder="JohnDoe@123mail.com"
    ...
    <CustomFormField
      ...
      <CustomFormField
        ...
        placeholder="Select a Physician">
          {Doctors.map((doctor) => (
            <SelectItem key={doctor.name} value={doctor.name} label={doctor.name}>
      ...
      <div className="flex flex-col gap-6 xl:flex-row">
        <CustomFormField
            ...
            label="Famliy Medical History"
            placeholder="Mother had Breast Cancer, etc."
        />
